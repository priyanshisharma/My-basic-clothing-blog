...
from myclothingblog.core.views import core
from myclothingblog.users.views import users
from myclothingblog.blog_posts.views import blog_posts
from myclothingblog.error_pages.handlers import error_pages
